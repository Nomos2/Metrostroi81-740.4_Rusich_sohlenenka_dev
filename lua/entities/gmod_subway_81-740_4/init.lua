...
function ENT:Think()
	...
	self:SetNW2Bool("BIPower",power and self.SF13.Value > 0)
	...
	self:SetNW2Bool("DAU",power and self.SF13.Value > 0 and self.BARS.DAU)
	self:SetNW2Bool("XOD",power and self.SF13.Value > 0 and self.Speed > 0.2 and not self.BARS.AO and not self.BARS.DisableDrive and self.BARS.Brake == 0 and self.BARS.Brake2 == 0)
	self:SetNW2Bool("Dnepr",power and self.SF13.Value > 0 and self.BARS.Dnepr)
	self:SetNW2Bool("Ispr",power and self.SF13.Value > 0 and self.BARS.Ispr)
	self:SetNW2Bool("LN",power and self.SF13.Value > 0 and self.BARS.LN)
	self:SetNW2Bool("AO",power and self.SF13.Value > 0 and self.BARS.AO)
