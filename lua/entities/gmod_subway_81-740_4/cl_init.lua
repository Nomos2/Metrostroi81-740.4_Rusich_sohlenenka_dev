...
--Головная часть
ENT.ButtonMap["PUU"] = {
    pos = Vector(814.8, 43, 2.2), --446 -- 14 -- -0,5
    ang = Angle(0,-90,40),
    width = 685,
    height = 110,
    scale = 0.0625,
...
ENT.ButtonMap["ALSPANELLAMPS"] = { -- дополнительные лампы АЛС
	pos = Vector(812,17.2,-0.01), --446 -- 14 -- -0,5
	ang = Angle(0,-90,40),
	width = 75,
	height = 50,
	scale = 0.0625,
...
ENT.ButtonMap["PUL"] = {
    pos = Vector(807, 34.5, -3.1), --446 -- 14 -- -0,5
    ang = Angle(0,-90,21.5),
    width = 100,
    height = 220,
    scale = 0.0450,
...
ENT.ButtonMap["PUR"] = {
    pos = Vector(806.5,13.5,-3.3), --446 -- 14 -- -0,5
    ang = Angle(0,-90,22),
    width = 220,
    height = 210,
    scale = 0.0450,
...
ENT.ButtonMap["ASNP"] = {
    pos = Vector(809.1,-11.5, 1.4), --446 -- 14 -- -0,5
    ang = Angle(0,-90,90),
    width = 56,
    height = 56,
    scale = 0.0625,
...
ENT.ButtonMap["ASNPScreen"] = {
    pos = Vector(809.1,-5.65,0.11), --446 -- 14 -- -0,5
    ang = Angle(0,-90,90),
    width = 520,
    height = 125,
    scale = 0.010,
...
ENT.ButtonMap["Tickers"] = {
    pos = Vector(163.5,-27.5,66.45), --446 -- 14 -- -0,5
    ang = Angle(0,90,90),
    width = 1024,
    height = 64,
    scale = 0.055,
...
ENT.ButtonMap["BTO"] = {
    pos = Vector(775.12,-21,-42), --446 -- 14 -- -0,5
    ang = Angle(0,0,0),
    width = 224,
    height = 50,
    scale = 0.0625,
...
ENT.ClientProps["FrontBrake"] = {--
    ...
    pos = Vector(835, -17, -53.9), -- (-23) старое значение по Y
    ang = Angle(30,-90,0),
	scale = 0.55,
    hide = 2,
}
...
for i=0,3 do
    ENT.ClientProps["TrainNumberR"..i] = {
        ...
        pos = Vector(705-i*6.6+4*6.6/2, -63.9, 14),
        ang = Angle(0,0,-3.29),
        skin=1,
        hide = 1.5,
...
for i=1,5 do
    ENT.ClientProps["speeddop"..i] = {
        ...
        pos = Vector(344.65, 1.32*(i-1)+2.8, 103.62),
        ang = Angle(10,0,0.2),
        skin = 0,
...
for i=1,5 do
    ENT.ClientProps["speedrek"..i] = {
        ...
        pos = Vector(344.420, 1.32*(i-1)+2.75, 103.44),
        ang = Angle(10,0,0.3),
        skin = 0,
...
--[[ENT.ClientProps["Test1"] = {
    model = "models/hunter/plates/plate.mdl",
    pos = Vector(100,60,-50),
    ang = Angle(0,0,0),
    hideseat = 0.2,
}
ENT.ClientProps["Test2"] = {
    model = "models/hunter/plates/plate.mdl",
    pos = Vector(100,-60,-50),
    ang = Angle(0,0,0),
    hideseat = 0.2,
}
ENT.ClientProps["Test3"] = {
    model = "models/hunter/plates/plate.mdl",
    pos = Vector(160,0,-50),
    ang = Angle(0,0,0),
    hideseat = 0.2,
}
ENT.ClientProps["Test4"] = {
    model = "models/hunter/plates/plate.mdl",
    pos = Vector(160,0,-50),
    ang = Angle(0,0,0),
    hideseat = 0.2,
...
ENT.ClientProps["PB"] = {
    ...
    pos = Vector(810.138672,35.572510,-30),
...
ENT.ClientProps["RearTrain"] = {
	...
	callback = function(ent,cl_ent)
		...
		local pos = FakeCouple:GetPos() --позиция XYZ (настраивается через верхние строки)
		cl_ent:GetPos(Vector(pos.x, pos.y, pos.z))
		
		local ang = FakeCouple:GetAngles() --поворот XYZ (настраивается через верхние строки)
		cl_ent:GetAngles(Angle(ang.x, ang.y, ang.z))
	end,
}
...
for i=0,3 do
    ENT.ClientProps["TrainNumberL"..i] = {
        model = "models/metrostroi_train/common/bort_numbers.mdl",
        pos = Vector(-505+i*6.6-4*6.6/2, 63.7, 18),
		...
		local FakeCouple = ent:GetNW2Entity("FakeCouple")
		if not IsValid(FakeCouple) then
			ent:ShowHide("TrainNumberL"..i,false)
			return
		end
		local FakeCouple = ent:GetNW2Entity("FakeCouple")
		cl_ent:SetParent(FakeCouple) --выдача родителя.
...
ENT.ButtonMap["RearDoor"] = {
    pos = Vector(-524,-15,55), ---334.8,14.5,9
    ang = Angle(0,90,90),
    width = 642,
    height = 2000,
    scale = 0.1/2,
...
ENT.ClientProps["lamps_salon_on_r"] = {
    model = "models/metrostroi_train/81-740/salon/lamps/lamps_on_rear.mdl",
    pos = Vector(0,0,0),
    ang = Angle(0,0,0),
	nohide=true,
	callback = function(ent,cl_ent)
		local FakeCouple = ent:GetNW2Entity("FakeCouple")
		if not IsValid(FakeCouple) then
			ent:ShowHide("lamps_salon_on_r",false)
			return
		end
		cl_ent:SetParent(FakeCouple) --выдача родителя.
...
ENT.ClientProps["lamps_salon_off_r"] = {
	...
	callback = function(ent,cl_ent)
		local FakeCouple = ent:GetNW2Entity("FakeCouple")
		if not IsValid(FakeCouple) then
			ent:ShowHide("lamps_salon_off_r",false)
			return
		end
		cl_ent:SetParent(FakeCouple) --выдача родителя.
...
local function GetDoorPosition(i,k,j)
	...
	then return Vector(652.5  - 35.0*k     -  338.8*i, -67.5*(1-2*k), 4.3)
	else return Vector(652.5  - 35.0*(1-k) -  338.8*i, -66*(1-2*k), 4.25)
	end
end

local function GetDoorPositionRear(i,k,j)
	if j == 0 
	then return Vector(35.8 - 35.0*k     - 232.2*i,-67.5*(1-2*k),3)
	else return Vector(35.8 - 35.0*(1-k) - 232.2*i,-66*(1-2*k),3)
	end
end
 ...
 ENT.Lights = {
    [1] = { "headlight",	Vector(858,0,0),Angle(0,0,0),Color(216,161,92),farz=5244,brightness = 4.5, fov=120, texture = "models/metrostroi_train/equipment/headlight",shadows = 1,headlight=true}, --Фары
    [2] = { "headlight",    Vector(968,0,50), Angle(-1,0,0), Color(255,0,0), fov=170 ,brightness = 0.3, farz=450,texture = "models/metrostroi_train/equipment/headlight2",shadows = 0,backlight=true}, --Красные фары 
    [3] = { "headlight",    Vector(358,40,43.9), Angle(50,40,-0), Color(206,135,80), fov=100,farz=200,brightness = 0,shadows=1}, --отсеки
}

ENT.ButtonMap["CAMS"] = {
    pos = Vector(809.2,52,10.58),
    ang = Angle(0,-58,90),
    width = 1024,
    height = 768,
    scale = 0.012,
...
function ENT:Initialize()
	...
	self.FakeCouple = self:GetNW2Entity("FakeCouple")
...
function ENT:UpdateWagonNumber()
    for i=0,3 do
        --if i< count then
            ...
            if IsValid(rightNum) then
                rightNum:SetPos(self:LocalToWorld(Vector(705-i*6.6+4*6.6/2, -63.9, 14)))
                rightNum:SetSkin(num)
            end
			local leftNum = self.ClientEnts["TrainNumberL"..i]
            if IsValid(leftNum) then
                leftNum:SetPos(self:LocalToWorld(Vector(-503+i*6.6-4*6.6/2, 63.7, 18)))
                leftNum:SetSkin(num)
	...
	if not IsValid(self.FakeCouple) then
		self.FakeCouple = self:GetNW2Entity("FakeCouple")		
	end
    end
end
...
for i=0,2 do
	for k=0,1 do
		self.ClientProps["door"..i.."x1"..k.."a1"] = {
			model = self:GetNW2String("skin_door_pass_2", "models/metrostroi_train/81-740/body/81-740_leftdoor2.mdl"),
			...
			local FakeCouple = self:GetNW2Entity("FakeCouple")
			cl_ent:SetParent(FakeCouple) --выдача родителя.
			local pos = FakeCouple:GetPos() --позиция XYZ (настраивается через верхние строки)
			cl_ent:GetPos(Vector(pos.x, pos.y, pos.z))
			local ang = FakeCouple:GetAngles() --поворот XYZ (настраивается через верхние строки)
		...
		self.ClientProps["door"..i.."x1"..k.."b1"] = {
			model = self:GetNW2String("skin_door_pass_1", "models/metrostroi_train/81-740/body/81-740_leftdoor1.mdl"),
			...
			--[[self.ClientProps["door_cab_t"] = {
			model =  self:GetNW2String("skin_door_end", "models/metrostroi_train/81-740/salon/door_br.mdl"),
			pos = Vector(0, 0, 0),
			ang = Angle(0,0,0),
			skin = self:GetNWInt("skin_skin_body", 0),
			hide=2,
			...
			--[[self.ClientProps["salonR"] = {
			model = self:GetNW2String("skin_interior_741", "models/metrostroi_train/81-740/salon/salon_rear.mdl"),
			pos = Vector(0,0,0),
			ang = Angle(0,0,0),
			skin = self:GetNWInt("skin_skin_interior", 0),
			hide=2,
...
local headlights = HL1*0.5+HL2*0.5
    ...
    local door_cab_t = self:Animate("door_cab_t",door_t /*self:GetPackedBool(169)*/ and  0.99/*(self.Door4 or 0.99)*/ or 0,0,1, 4, 1) 
