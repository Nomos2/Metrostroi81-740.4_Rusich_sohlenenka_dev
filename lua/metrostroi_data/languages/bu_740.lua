...
Common.740.BBER             = Резервно включване на ББЕ
Common.740.BBE              = Включване на ББЕ
Common.740.CabLightStrength = Яркост на осветлението в кабината
Common.740.AppLights        = Осветление на хардуерното отделение
Common.740.BARSBlock        = Блокиране на дефектни леопарди
...
Common.740.SFV24            = SF23: Контрол на вътрешната вентилация
Common.740.SFV26            = SF24: Вътрешно вентилационно захранване
Common.740.SFV27            = SF25: Хранене на патогена
Common.740.SFV28            = SF26: Захранване на зареждащия кондензатор
Common.740.SFV29            = SF27: Токоприемници
Common.740.SFV30            = SF28: Табло
Common.740.SFV31            = SF29: Резерва
Common.740.SFV32            = SF30: Видео
Common.740.SFV33            = SF31: Камара
Common.740.SFV34            = SF32: ПрОст
Common.740.SFV35            = SF33: Резерва
...
Entities.gmod_subway_81-740_4.Spawner.AsyncSound.2         	  = @[Spawner.740.AsyncSound1]
Entities.gmod_subway_81-740_4.Spawner.AsyncSound.3            = @[Spawner.740.AsyncSound2]
Entities.gmod_subway_81-740_4.Spawner.AsyncSound.4         	  = @[Spawner.740.AsyncSound3]
Entities.gmod_subway_81-740_4.Spawner.AsyncSound.5            = @[Spawner.740.AsyncSound4]
Entities.gmod_subway_81-740_4.Spawner.AsyncSound.6            = @[Spawner.740.AsyncSound5]
